  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="px-7 overflow-y-auto min-h-0 flex-1 flex flex-col gap-4 py-2">
          <div className="flex flex-col gap-1.5">
            ...
            <textarea
              ...
              rows={3}
              maxLength={2000}
              className="focus-ring w-full resize-none bg-base border border-outline/50 rounded-lg px-3.5 py-2.5 text-sm text-ink placeholder:text-muted/50 focus:border-accent-dim transition-colors"
            />
          </div>
          ...
          <div className="flex flex-col gap-1.5">
            ...
            {loading ? (
              <div className="flex items-center justify-center py-10 rounded-lg bg-base border border-line">
                <IconRefresh className="w-5 h-5 animate-spin text-muted" />
              </div>
            ) : (
              <div className="rounded-lg bg-base border border-line p-3.5 font-mono text-[11px] text-muted whitespace-pre-wrap break-all leading-relaxed max-h-[200px] overflow-y-auto select-all">
                {report}
              </div>
            )}
          </div>
        ...
        <div className="flex items-center justify-between gap-3 px-7 pt-4 pb-7 shrink-0">
          ...
          <div className="flex items-center gap-2.5">
            ...
            <motion.button
              ...
              disabled={!report}
              className="focus-ring cursor-pointer flex items-center gap-2 px-4 py-2.5 rounded-lg bg-danger hover:bg-danger/90 text-sm font-medium text-white transition-colors disabled:opacity-40 disabled:cursor-not-allowed"
            >
