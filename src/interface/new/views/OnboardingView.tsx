  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
      ...
      <button
        ...
        className="focus-ring cursor-pointer flex flex-col items-start gap-1.5 rounded-btn border border-outline/50 p-3.5 text-left transition-colors hover:border-accent-dim hover:bg-raised"
      >
        <span className="flex items-center gap-2 w-full">
          <IconLayoutList className="w-3.5 h-3.5 text-muted" />
          <span className="text-xs font-medium text-ink">
            {ts('classic_ui_label')}
          </span>
        </span>
                      ...
                      >
                        <div className="flex flex-col gap-6">
                          ...
                          <div className="flex flex-col gap-2.5">
                            ...
                            <InterfacePicker onChooseClassic={onChooseClassic} />
                          </div>
                        </div>
                      </StepShell>
                    )}
